...
export class Contacto extends ComponenteBase {
  private listaContacto = new ListaContacto();
  private formulario = new FormularioContacto();
  ...
  crearElemento() {
    ...
    this.elemento = elemento.firstElementChild as HTMLElement;
  }
